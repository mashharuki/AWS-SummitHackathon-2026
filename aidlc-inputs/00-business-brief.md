...
[⚠️] 提案資料の初稿作成
締切：明日 12:00
現在のサボり方：まだ寝かせてOK。15:00に再判断。(1行提案)
```

通常のタスク管理アプリのように、単なる「やること一覧」にはしない。
...
まだ誰からもリマインドが来ていないし、
関連する会議も明日の午後だから、
今は構成だけ作って寝かせるのが一番人間らしいサボり方かもぉ。
```

この画面では、単なる慰めではなく、外部ツール上の根拠も見せる。
...
```
・たしかに、まだ寝かせる
・いや、この人相手だと早めにやった方がいい
・リマインドが来てないならまだ大丈夫
・Bさん案件ならゆっくりでいい
・Aさん案件なら今やる
```

この反応が、ユーザーの本音データとして蓄積される。
