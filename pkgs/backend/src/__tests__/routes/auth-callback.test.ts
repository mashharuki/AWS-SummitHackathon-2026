...
describe("GET /auth/slack/callback — success path (new secret)", () => {
  ...
  it("returns 500 with unknown message when token exchange error is missing", async () => {
    mockGetSlackClientSecret.mockResolvedValue(
      JSON.stringify({
        clientId: "slack-client-id",
        clientSecret: "slack-client-secret",
  ...
  it("falls back to secret name when CreateSecretCommand ARN is missing", async () => {
    mockGetSlackClientSecret.mockResolvedValue(
      JSON.stringify({
        clientId: "slack-client-id",
        clientSecret: "slack-client-secret",
  ...
  it("falls back to secret name when UpdateSecretCommand ARN is missing", async () => {
    mockGetSlackClientSecret.mockResolvedValue(
      JSON.stringify({
        clientId: "slack-client-id",
        clientSecret: "slack-client-secret",
