...
**作成日**: 2026-05-09
**バージョン**: 1.1.0
**更新日**: 2026-05-10（U-03c 追加・US-18 追加）
...
|----------|------------------------|-----------|---------|--------|
| US-01 | Slack からタスクが自動抽出される | U-03a task-extractor | U-03c task-organizer（v1.1.0で依存関係分析を追加）/ U-04 api / U-02 infra | MUST |
| US-02 | Gmail からタスクが自動抽出される | U-03a task-extractor | U-03c task-organizer（v1.1.0）/ U-04 api / U-02 infra | MUST |
| US-03 | Google Calendar からタスクが自動抽出される | U-03a task-extractor | U-03c task-organizer（v1.1.0）/ U-04 api / U-02 infra | MUST |
...
| US-18 | タスク依存関係の自動分析と最もサボれる順序の把握 | U-03c task-organizer | U-03b sabori-proposer / U-05 web | SHOULD（v1.1.0）|
...
| Story | エージェント担当範囲 |
|-------|-----------------|
| US-18 | 複数タスクの依存関係分析・最もサボれる順序の算出（TaskOrganizerAgent）|

補助担当: US-01 / US-02 / US-03（v1.1.0 で TaskExtractor 出力を受け取り依存関係分析を追加）
...
| E-01b | タスク構造化・手順整理（v1.1.0）| U-03c task-organizer | U-03b sabori-proposer / U-05 web |
...
| US-18 | スコープ外 | v1.1.0（M3 決勝）。U-03c task-organizer と合わせて実装 |
